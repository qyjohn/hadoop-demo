...
public class Lab1v1
{
	...
	public static class CountryPartitioner extends Partitioner <RecordWritable, Text>
	{
		@Override
		public int getPartition(RecordWritable key, Text text, int numberOfPartitions)
		{
			return Math.abs(key.hashCode() % numberOfPartitions);
			}
	}	

	public static class RecordComparator extends WritableComparator {
		...
		public int compare(WritableComparable w1, WritableComparable w2) {
			RecordWritable key1 = (RecordWritable) w1;
			RecordWritable key2 = (RecordWritable) w2;          
...
//				}
	...
	public static void main(String[] args) throws Exception
	{
		...
		job.setJarByClass(Lab1v1.class);
